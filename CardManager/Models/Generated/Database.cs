...
// 
//     Connection String Name: `pgsql`
//     Provider:               `Npgsql255`
//     Connection String:      `Host=localhost;Port=5432;User ID=postgres;password=**zapped**;`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace CardManagerRepo
{
	...
	public partial class CMRepo : Database
	{
		public CMRepo() 
			: base("pgsql")
		{
		...
		public CMRepo(string connectionStringName) 
        ...
        public static CMRepo GetInstance()
        {
			if (_instance!=null)
				return _instance;
		...
		[ThreadStatic] static CMRepo _instance;
		...
		{
			public static CMRepo repo { get { return CMRepo.GetInstance(); } }
