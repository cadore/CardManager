...
namespace CardManager.Utils
{
    public class TabControlUtil
    {
        ...
        public void AddTab(XtraUserControl userControl, string titleTab, bool newTab, bool showCloseButton)
        {
            //estancia uma nova Tab passando os parametros
            XtraTabPage sysTabPage1 = new XtraTabPage();

            // mostra o botao de fechamento da Tab
            sysTabPage1.ShowCloseButton = showCloseButton ? DefaultBoolean.True : DefaultBoolean.False;
